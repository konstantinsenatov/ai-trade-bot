...
def run_historical_backtest(
    ...
    symbol: str = "BTCUSDT",
) -> tuple[dict[str, Any], list[float], list[tuple[int, float, float, float, float, int]]]:
...
def main():
    ...
    parser.add_argument("--fee", type=float, default=0.001, help="Trading fee (default: 0.001)")
    parser.add_argument(
        "--threshold", type=float, default=0.005, help="Strategy threshold (default: 0.005)"
    )
    parser.add_argument("--symbol", default="BTCUSDT", help="Trading symbol (default: BTCUSDT)")
    parser.add_argument("--save-data", action="store_true", help="Save historical data to CSV")
    parser.add_argument("--out", type=str, help="Output CSV file for results")
    ...
    try:
        ...
        if args.save_data:
            ...
            csv_path = data_source.save_to_csv(
                bars, f"historical_{args.symbol}_{args.timeframe}.csv"
            )
